      ...
      >
        <header className="flex items-start justify-between gap-4 border-b border-border px-4 py-4 sm:px-6">
          <div className="min-w-0">
            <h2 className="text-lg font-semibold leading-6 text-foreground">Salik Transactions</h2>
        ...
        <div className="max-h-[calc(88vh-76px)] overflow-y-auto">
          <section className="grid grid-cols-4 border-b border-border bg-white/[0.02]">
            ...
            <SummaryItem label="Total" value={formatAed(summary.total)} valueClassName="text-tint-green-foreground" />
          </section>
                    ...
                    >
                      ...
                      <span
                        className={`inline-flex w-fit items-center rounded-full border px-2 py-0.5 text-[11px] font-semibold ${
                          statusLabel === "Paid"
                            ? "border-tint-green-foreground/20 bg-tint-green text-tint-green-foreground"
                            : "border-tint-rose-foreground/20 bg-tint-rose text-tint-rose-foreground"
                        }`}
                      >
                        {statusLabel}
                      </span>
          ...
          <footer className="sticky bottom-0 flex min-h-14 items-center justify-between gap-4 border-t border-border bg-card px-4 py-3 sm:px-6">
            ...
            <span className="font-ibm-plex-mono text-base font-semibold tabular-nums text-tint-green-foreground">
