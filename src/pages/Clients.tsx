...
const Clients = () => {
  ...
  const openEdit = (c: ClientRecord) => {
    ...
    setForm({
      ...
      license_issuing_country: c.license_issuing_country ?? "",
      traffic_file_number: c.traffic_file_number ?? "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.license_type) {
      toast.error("Please choose the driving licence type");
      return;
    }
    ...
    const payload: any = {
      ...
      license_issuing_country:
        form.license_type === "uae" ? null : form.license_issuing_country.trim() || null,
      traffic_file_number:
        form.license_type === "uae" ? form.traffic_file_number.trim() || null : null,
      unified_number:
        form.license_type === "uae" ? null : form.unified_number.trim() || null,
                ...
                {step === 1 ? (
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="grid gap-1.5">
                      ...
                      <Tabs
                        ...
                        onValueChange={(license_type) =>
                          setForm({
                            ...form,
                            license_type: license_type as typeof form.license_type,
                          })
                        }
                      >
                    ...
                    {form.license_type === "uae" && (
                      <div className="grid gap-1.5">
                        <Label htmlFor="traffic-file" className="text-foreground">Traffic File Number</Label>
                        <Input
                          id="traffic-file"
                          dir="ltr"
                          inputMode="numeric"
                          value={form.traffic_file_number}
                          onChange={(event) =>
                            setForm({
                              ...form,
                              traffic_file_number: event.target.value.replace(/\D/g, ""),
                            })
                          }
                          className="bg-input border-border text-foreground"
                        />
                    ...
                    {(form.license_type === "foreign" || form.license_type === "international") && (
                      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        <div className="grid gap-1.5">
                          <Label htmlFor="license-country" className="text-foreground">Issuing Country</Label>
                          <Input
                            id="license-country"
                            value={form.license_issuing_country}
                            onChange={(event) =>
                              setForm({ ...form, license_issuing_country: event.target.value })
                            }
                            className="bg-input border-border text-foreground"
                          />
                        </div>
                        <div className="grid gap-1.5">
                          <Label htmlFor="client-uid" className="text-foreground">Unified Number (UID)</Label>
                          <Input
                            id="client-uid"
                            dir="ltr"
                            inputMode="numeric"
                            placeholder="UAE unified number"
                            value={form.unified_number}
                            onChange={(event) =>
                              setForm({
                                ...form,
                                unified_number: event.target.value.replace(/\D/g, ""),
                              })
                            }
                            className="bg-input border-border text-foreground"
                          />
