...
1. **Визуальные правки** — не трогать логику, props, data fetching
2. **Новый функционал** — новый файл, подключать после проверки
3. **App.tsx** — не трогать без явного подтверждения
